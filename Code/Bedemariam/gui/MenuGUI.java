  ...
  * Project: Project 2 
  * Date: 02/08/21
  * Purpose: Class that creates the main GUI for the program and the means to make Shape objects.
  *           
  */
package Bedemariam.gui;

import Bedemariam.Shape;
import Bedemariam.three_dimensional.*;
import Bedemariam.two_dimensional.*;
import javax.swing.*;
...
public class MenuGUI extends JFrame {
    ...
    public MenuGUI() {
        ...
        JComboBox<Bedemariam.Shape> shapeJComboBox = new JComboBox<>(shapeList);
